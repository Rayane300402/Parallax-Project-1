...
// remove/add attirubte function, pass in addition to what ever you want to remove 
...
// disable image drag events, can't press picture and try and drag them via mouse
...
// how much of the image should be on the page to be considered on the page
