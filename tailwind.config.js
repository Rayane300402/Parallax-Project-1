...
export default {
  ...
  theme: {
    extend: {
      ...
      // centerize containers always, with default padding
      container: {
        center: true,
        padding: {
          default: "1rem",
      ...
      // make size dynamic via clamp
      fontSize: {
        // 2 values inside an array, clamp => smalled i want it to be, calc is the desired size,
        // and that's the largest (1.00rem, calc, 1.20)... the after comma is the line height
        // taken from utopia.fyi helps with reponsice fluid design
